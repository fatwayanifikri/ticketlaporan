...
font-size: 16px;"> Last access : <?php date_default_timezone_set('Asia/Jakarta');echo date('d-m-Y H:i:s');?> &nbsp; <a href="#" type="submit" class="btn btn-danger square-btn-adjust"><i class="fa fa-sign-out"></i> Logout</a></div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
			 ...
			 <br/>
			    <p>Input Ticket Number :</p>
				<div class="form-group">
				</div>
				<form action="../ticket/cari" method="GET" class="form-inline">
					<input class="form-control" type="text" name="cari" placeholder="Input Ticket Number" value="{{ old('cari') }}">
					<input class="btn btn-primary ml-3" type="submit" value="INPUT">
				</form>
				</br> 
...
<tr>
		...
		<tr>
			...
			<td>{{ $t->suspect }}</td>
			<td>{{ $t->location }}</td>
			<td><a class="btn btn-warning btn-sm" href="../ticket/edit/{{ $t->t_id }}">Update</a></td>
		</tr>
		@endforeach
	</table>
